    ...
    case 3: case 4: //run
        ...
        for(unsigned int i = 0; i < 65536; i++){
            ...
            switch(i){ //hardcoded program into the memory
                case 0: memory[i] = 0xa9;
                    break;
                case 1: memory[i] = 0x01;
                    break;
                case 2: memory[i] = 0x85;
                    break;
                case 3: memory[i] = 0x01;
                    break;
                case 4: memory[i] = 0xa9;
                    break;
                case 5: memory[i] = 0x05;
                    break;
                case 6: memory[i] = 0x8d;
                    break;
                case 7: memory[i] = 0x01;
                    break;
                case 8: memory[i] = 0x02;
                    break;
                case 9: memory[i] = 0x00;
                    break;
                default:
